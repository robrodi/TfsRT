...
namespace TfsRt.Data
{
    ...
    public abstract class SampleDataCommon
    {
        ...
        {
            this.Image = new BitmapImage(new Uri(SampleDataCommon._baseUri, path));
        }
    ...
    public class SampleDataItem : SampleDataCommon
    {
        ...
        public SampleDataGroup Group { get; set;}
    }
